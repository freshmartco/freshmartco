   ...
   <div class="sidebar-content">
      ...
      <div class="card card-sidebar-mobile">
         <ul class="nav nav-sidebar" data-nav-type="accordion">
            ...
            <li class="nav-item nav-item-submenu">
               <a href="<?php echo site_url('country/');?>" class="nav-link <?php if($active_menu=="country") { echo "active"; } ?>">
               <i class="icon-stack2"></i> <span>Country Master</span></a>
            </li> 
            <li class="nav-item nav-item-submenu">
               <a href="<?php echo site_url('country/state_index');?>" class="nav-link <?php if($active_menu=="state") { echo "active"; } ?>">
               <i class="icon-stack2"></i> <span>State Master</span></a>
            </li> 
             <li class="nav-item nav-item-submenu">
               <a href="<?php echo site_url('country/city_index');?>" class="nav-link <?php if($active_menu=="city") { echo "active"; } ?>">
               <i class="icon-stack2"></i> <span>City Master</span></a>
            </li>
             <li class="nav-item nav-item-submenu">
