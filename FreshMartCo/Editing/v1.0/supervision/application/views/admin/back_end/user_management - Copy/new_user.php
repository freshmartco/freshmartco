		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="<?php echo site_url('user_management');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">New User</span> </h4>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
                    <form class="form-horizontal" action="<?php echo site_url('user_management/save_user');?>" method="POST" enctype="multipart/form-data">
						...
						<div class="card">
							...
							<div class="row">
								...
								<div class="col-md-10">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="cmp_name" id="cmp_name" required autocomplete="off">
											</div>
										</div>
										<div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control datepicker" name="from_date" id="from_date" required autocomplete="off">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>To Date: <span class="text-danger">*</span></label>
												<input type="text" class="form-control datepicker" name="to_date" id="to_date" required autocomplete="off">
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="phone" id="phone" minlength="10" maxlength="10" onkeypress="return isNumber(event)" required autocomplete="off">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Company Email: <span class="text-danger">*</span></label>
												<input type="email" class="form-control" name="email" id="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required autocomplete="off">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="person" id="person" required autocomplete="off">
											</div>
										</div> 
									</div>
									...
									<div class="row">
										...
										<table class="table table-bordered">
											...
											<tbody id="gstn_div">
													<tr id="row_1"> 
														<td>
                                                        <input type="text" class="form-control" name="ip_address[]" id="ip_address" required autocomplete="off">
														</td>
									...
									<button type="submit" class="btn btn-primary" name="upload_now" style="width:13%" id="h-default-basic-start">Save</button>
									</div>
								</div>
							</div>
						</div>
