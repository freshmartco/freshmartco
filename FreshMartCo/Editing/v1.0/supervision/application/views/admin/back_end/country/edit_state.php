...
<html lang="en">
   ...
   <body>
      ...
      <div class="page-header page-header-light">
         <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
               <h4><a href="<?php echo site_url('country/state_index');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">Edit State</span> </h4>
      ...
      <div class="content">
         ...
         <div class="row">
            <div class="col-md-12">
               <form class="form-horizontal" action="<?php echo site_url('country/update_state/').$stateDetails['state_id'];?>" method="POST" enctype="multipart/form-data">
                  <!-- Other inputs -->
                  <div class="card">
                              ...
                              <div class="row">
                                       ...
                                       <label>Country Name: <span class="text-danger">*</span></label>
                                         ...
                                         <?php
                                          if(!empty($country_master)){
                                             ...
                                             {
                                                if($stateDetails['country_id'] == $value['country_id'])
                                                {
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="state_name" id="state_name" required autocomplete="off" value="<?=$stateDetails['state_name'] ?>" required>
                                    </div>
                                 </div>
                              </div>                                                            
                              <br/>
