...
<html lang="en">
   ...
   <body>
      ...
      <div class="page-header page-header-light">
         <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
               <h4><a href="<?php echo site_url('user_management');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">Add Area</span> </h4>
      ...
      <div class="content">
         ...
         <div class="row">
            <div class="col-md-12">
               <form class="form-horizontal" action="<?php echo site_url('country/save_area');?>" method="POST" enctype="multipart/form-data">
                  <!-- Other inputs -->
                  <div class="card">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="area_name" id="area_name" required autocomplete="off" required>
                                    </div>
                                 </div>
                              </div>
