			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">State Management</span> </h4>
						<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
					</div>

					<div class="header-elements d-none">
							<a href="<?php echo site_url('country/add_state');?>" class="btn btn-labeled btn-labeled-right bg-primary">ADD State<b><i class="fa fa-plus" aria-hidden="true"></i></b></a>
					</div>
				</div>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">State Management</span>
						</div>
										...
										if($value['status']==0)
										{
										 ...
										 echo '
										 	<tr>
										 		...
										 		<td>
													<label class="switch">
													<input type="checkbox" id="'.$value['state_id'].'" '.$status.' onclick="change_status(this.id);">
													...
													<div class="list-icons">
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-right">	  
																...
																<a href="'.site_url('country/edit_state/'.$value['state_id']).'"   class="dropdown-item"><i class="fa fa-pencil"></i> Edit Details</a>

																<a style="display:none;" href="javascript:void(0);"  onclick="delete_State('.$value['state_id'].')"  class="dropdown-item "><i class="fa fa-trash"></i> Delete</a>
															</div>
														</div>
													</div>
												</td>
			...
			bootbox.confirm({
                ...
                callback: function (result) {
					...
					{					    		 
						 jQuery.ajax({
							type:"POST",
							url:"<?php echo base_url(); ?>" + "index.php/country/change_stateStatus",
							datatype:"text",
							data:{state_id:origin,value:value},
			...
			{  
                ...
                callback: function (result) {
					if(result==true)
					{
						...
						jQuery.ajax({
						type:"POST",
						url:"<?php echo base_url(); ?>" + "index.php/country/delete_state",
						datatype:"text",
						data:{id:id},
						success:function(response)
						{
