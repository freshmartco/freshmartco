...
<html lang="en">
   ...
   <body>
      ...
      <div class="page-header page-header-light">
         <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
               <h4><a href="<?php echo site_url('country/city_index');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">Edit City</span> </h4>
         ...
         <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
               <div class="breadcrumb">
                  ...
                  <span class="breadcrumb-item active">Edit City</span>
               </div>
               <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
         </div>
      ...
      <div class="content">
         ...
         <div class="row">
            <div class="col-md-12">
               <form class="form-horizontal" action="<?php echo site_url('country/update_city/'.$cityDetails['city_id']);?>" method="POST" enctype="multipart/form-data">
                  <!-- Other inputs -->
                  <div class="card">
                              ...
                              <div class="row">
                                         ...
                                         <?php
                                          if(!empty($country_master)){
                                             foreach ($country_master as $key => $value) {
                                                if($cityDetails['country_id'] == $value['country_id'])
                                                {
                                         ...
                                         <?php
                                          if(!empty($state_master)){
                                             foreach ($state_master as $key => $value) {
                                                if($cityDetails['state_id'] == $value['state_id'])
                                                { 
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="city_name" id="city_name" required autocomplete="off" value="<?=$cityDetails['city_name']; ?>" required>
                                    </div>
                                 </div>
                              </div>                                                            
                              <br/>
