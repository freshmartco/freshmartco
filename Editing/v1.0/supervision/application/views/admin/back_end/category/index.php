	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Category Management</span> </h4>
			...
			<!-- content area -->
			 <div class="row">
            <div class="col-md-12">
               <form class="form-horizontal" action="<?php echo site_url('category/save_category');?>" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="category_name" id="category_name" required autocomplete="off" required>
                                    </div>
                                 </div>
                              </div>                                                            
                              <br/>
								...
								if($value['status']==0)
								{
								 ...
								 echo '
								 	<tr>
								 		...
								 		<td  style="display: none;">'.$i.'</td>  
								 		<td> <input  id="cont_'.$value['category_id'].'" value="'.$value['category_name'].'" class="form-control" onchange=update_category("'.$value['category_id'].'"); readonly/> 
								 		</td>		

				 				 		<td>
											<label class="switch">
											<input type="checkbox" id="'.$value['category_id'].'" '.$status.' onclick="change_status(this.id);">
										...
										<div class="list-icons">
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right">	  
													...
													<a href="javascript:void(0);" class="dropdown-item" onclick="edit_category('.$value['category_id'].')"><i class="fa fa-pencil"></i> Edit Details</a>

													<a style="display:none;" href="javascript:void(0);"  onclick="delete_country('.$value['category_id'].')"  class="dropdown-item "><i class="fa fa-trash"></i> Delete</a>
												</div>
											</div>
										</div>
									</td>
...
<script type="text/javascript">
	...
	{ 
		$('#cont_'+category_id).attr('readonly', false); 
	}

	function update_category (category_id)
	{ 
		var category_name=$('#cont_'+category_id).val();

		if(category_name !="" )
		{
			jQuery.ajax({
			type:"POST",
			url:"<?php echo base_url(); ?>" + "index.php/category/update_category",
			datatype:"text",
			...
			bootbox.confirm({
                ...
                callback: function (result) {
					...
					{					    		 
						 jQuery.ajax({
							type:"POST",
							url:"<?php echo base_url(); ?>" + "index.php/category/change_categoryStatus",
							datatype:"text",
							data:{category_id:origin,value:value},
							success:function(response)
							{ 
								bootbox.alert({
									title: 'Message',
