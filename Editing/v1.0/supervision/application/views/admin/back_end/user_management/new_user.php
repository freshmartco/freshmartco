                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <input type="password" class="form-control" name="password" id="password" onchange="check_password();"  required autocomplete="off">											
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       <label>Confirm Password: <span class="text-danger">*</span></label>
                                       <input type="password" class="form-control" name="confirm_password" id="confirm_password"  onchange="check_password();" required autocomplete="off">
                                    </div>
                                 </div>
                              </div>
