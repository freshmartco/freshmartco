		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="<?php echo site_url('user_management');?>"> <i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">Edit User Master</span> </h4>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
                    <form class="form-horizontal" action="<?php echo site_url('user_management/update_user_details/'.$user_details['origin']);?>" method="POST" enctype="multipart/form-data">
						...
						<div class="card">
							...
							<div class="row">
								...
								<div class="col-md-10">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="username" id="cmp_name" required autocomplete="off" value="<?php echo $user_details['username'];  ?>">
											</div>
										</div>
										<div class="col-md-6">
											 <div class="form-group">
											<label>Status: <span class="text-danger">*</span></label>
												...
												<option value="0" <?php if($user_details['status']==0){ echo "selected";}?> >Active</option>
												<option value="1" <?php if($user_details['status']==1){ echo "selected";}?>>In-active</option>
												</select>											
											</div>
										</div>
									</div> 
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="email" class="form-control" name="email" id="email" required autocomplete="off" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" value="<?php echo $user_details['email'];  ?>">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Phone No: <span class="text-danger">*</span></label>
												<input type="text" class="form-control" name="phone" id="phone" required autocomplete="off" minlength="10" maxlength="10" onkeypress="return isNumber(event)" value="<?php echo $user_details['phone'];  ?>">
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											...
											<label>Password: <span class="text-danger">*</span></label>
												<input type="password" class="form-control" name="password" id="password" onchange="check_password();"  autocomplete="off" value="" required="">											
											</div>
										</div> 
										<div class="col-md-6">
											<div class="form-group">
												<label>Confirm Password: <span class="text-danger">*</span></label>
												<input type="password" class="form-control" name="confirm_password" id="confirm_password"  onchange="check_password();"  autocomplete="off" value="" required="">
											</div> 
										</div>
									</div>  
		                                       ...
		                                       <select class="form-control" name="user_type" id="user_type" required>
		                                          ...
		                                          if(!empty($user_type)){
		                                          	foreach ($user_type as $key => $value) {
		                                          		if($value['origin'] == $user_details['user_type'])
		                                          		{
															echo '<option value="'.$value['origin'].'" selected>'.$value['user_type'].'</option>';
		                                          		}else
		                                          		{
		                                          			echo '<option value="'.$value['origin'].'">'.$value['user_type'].'</option>';
		                                          		}
									...
									<button type="submit" class="btn btn-primary"style="width:13%" id="h-default-basic-start">Update</button>
									</div>
								</div>
							</div>
						</div>
