		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="<?php echo site_url('customers');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">Edit customer</span> </h4>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
                    <form class="form-horizontal" action="<?php echo site_url('customers/update_customer/'.$customers[0]['id']);?>" method="POST" enctype="multipart/form-data">
                        
						<!-- Other inputs -->
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title"><b>Edit Customer</b></h5>
							...
							<div class="row">
								...
								<div class="col-md-4">
										<input type="text" class="form-control" name="name" id="name" required autocomplete="off" value="<?php echo $customers[0]['name'];?>">
								</div>
										<div class="col-md-2">
												<label><b>City: <span class="text-danger">*</span></b></label>
										</div>
										<div class="col-md-4">
											<input type="text" class="form-control" name="city" id="city" required autocomplete="off" value="<?php echo $customers[0]['city'];?>">
										</div>
							</div>
							<br/>
							...
							<div class="row">
								...
								<div class="col-md-4">
										<input type="email" class="form-control" name="email" id="email" required autocomplete="off" value="<?php echo $customers[0]['email'];?>">
								</div>
										<div class="col-md-2">
												<label><b>State: <span class="text-danger">*</span></b></label>
										</div>
										<div class="col-md-4">
											<input type="text" class="form-control" name="state" id="state" required autocomplete="off" value="<?php echo $customers[0]['state'];?>">
										</div>
							</div>
							<br/>
							...
							<div class="row">
								...
								<div class="col-md-4">
										<input type="text" class="form-control" onkeypress="return isNumber();" name="phone" id="phone" required autocomplete="off" minlength="10" maxlength="10" value="<?php echo $customers[0]['phone'];?>">
								</div>
										<div class="col-md-2">
												<label><b>Zip: <span class="text-danger">*</span></b></label>
										</div>
										<div class="col-md-4">
											<input type="text" class="form-control" onkeypress="return isNumber();" name="zip" id="zip" required autocomplete="off" minlength="6" maxlength="8" value="<?php echo $customers[0]['zip'];?>">
										</div>
							</div>
							<br/>
							...
							<div class="row">
								...
								<div class="col-md-4">
										<input type="text" class="form-control" name="address" id="address" required autocomplete="off" value="<?php echo $customers[0]['address'];?>">
								</div>
										<div class="col-md-2">
												<label><b>Company Name: <span class="text-danger">*</span></b></label>
										</div>
										<div class="col-md-4">
											<input type="text" class="form-control" name="company_name" id="company_name" required autocomplete="off" value="<?php echo $customers[0]['company_name'];?>">
										</div>
							</div>
							<br/>
							...
							<div class="row">
								...
								<label><b>Profile Picture: <span class="text-danger"></span></b></label>
									...
									<div class="col-md-4">	 
										<input type="file" name="photo" id="photo" class="form-control-uniform" data-fouc>
										<span class="form-text text-muted">Max file size 5 Mb</span> 
									</div>
								<div class="col-md-6">
								<?php
									if($customers[0]['image_path'] !="")
									{
										$profile_pic=base_url().$customers[0]['image_path'];
									}
									else
									{
								...
								?>
								 <img src="<?php echo $profile_pic;?>" alt="" height="50">
								</div>
