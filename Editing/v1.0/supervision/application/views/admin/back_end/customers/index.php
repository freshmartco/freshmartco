													...
													<div class="list-icons">
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-right">		
																...
																<a href="javascript:void(0);" id="view_'.$row['origin'].'" onclick="view_customer_details('.$row['origin'].');" class="dropdown-item"><i class="fa fa-eye"></i> View Details</a>	
																
																<a href="'.site_url('customers/edit_customers/'.$row['origin']).'" class="dropdown-item"><i class="fa fa-pencil"></i> Edit Details</a>
																<a href="javascript:void(0);" id="del_'.$row['origin'].'" onclick="delete_customer('.$row['origin'].');" class="dropdown-item"><i class="fa fa-trash"></i> Delete</a>
															</div>
														</div>
													</div>
												</td>
