...
! function(a, b) {
    ...
    a.fn.extend({
        ...
        _enableAria: function(a) {
            return null == a || a ? this.children().removeClass("disabled") && this.removeClass("disabled")._aria("disabled", "false") : this.children().addClass("disabled") && this.addClass("disabled")._aria("disabled", "true")
        },
